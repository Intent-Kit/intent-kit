...
# ///
"""
Intent CLI - Setup tool for Intent projects
...
app = typer.Typer(
name="intent",
help="Setup tool for Intent intent-driven development projects",
...
def download_template_from_github(ai_assistant: str, download_dir: Path, *, script_type: str = "sh", verbose: bool = True, show_progress: bool = True, client: httpx.Client = None, debug: bool = False, github_token: str = None) -> Tuple[Path, dict]:
    ...
    pattern = f"intent-templates-{ai_assistant}-{script_type}"
    matching_assets = [
...
def init(
    ...
    enhancement_lines = [
        ...
        f"○ [cyan]/intent.checklist[/] [bright_black](optional)[/bright_black] - Generate quality checklists to validate requirements completeness, clarity, and consistency (after [cyan]/intent.plan[/])"
    ]
