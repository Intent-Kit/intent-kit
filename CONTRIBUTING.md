...
Hi there! We're thrilled that you'd like to contribute to Intent Kit. Contributions to this project are [released](https://help.github.com/articles/github-terms-of-service/#6-contributions-under-repository-license) to the public under the [project's open source license](LICENSE).
...
## AI contributions in Intent Kit

> [!IMPORTANT]
>
> If you are using **any kind of AI assistance** to contribute to Intent Kit,
> it must be disclosed in the pull request or issue.

We welcome and encourage the use of AI tools to help improve Intent Kit! Many valuable contributions have been enhanced with AI assistance for code generation, issue detection, and feature definition.

That being said, if you are using any kind of AI assistance (e.g., agents, ChatGPT) while contributing to Intent Kit,
...
- **Clear rationale** - You can explain why the change is needed and how it fits within Intent Kit's goals  
...
- Generic suggestions that don't address specific Intent Kit needs
