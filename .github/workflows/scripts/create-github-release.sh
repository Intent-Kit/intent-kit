...
gh release create "$VERSION" \
  ...
  .genreleases/intent-kit-template-cursor-agent-sh-"$VERSION".zip \
  .genreleases/intent-kit-template-cursor-agent-ps-"$VERSION".zip \
  ...
  .genreleases/intent-kit-template-amp-sh-"$VERSION".zip \
  .genreleases/intent-kit-template-amp-ps-"$VERSION".zip \
