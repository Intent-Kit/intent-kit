...
Following the intent methodology's operational model for planning:

**Shaping Stage:**

- Weight motives, biases, and modes to form the implementation approach
- Apply design archetype: Choose architect (scale), hacker (speed), craftsman (quality), scholar (analysis), zen_coder (simplicity)

**Injection Stage:**

- Integrate intent context into AI reasoning for planning
- Follow bias principles: Functional purity, minimalist UX, modular composition
- Adhere to rules: Simplicity over cleverness, readability is longevity, fail fast refine later

**Action Tendencies:**

- Use verbose naming for clarity
- Apply abstract-level commenting
- Follow scenario-driven testing approach
